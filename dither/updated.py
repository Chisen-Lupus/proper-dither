...
### NOTE: TESTING CODE BUT CAN USE FOR 2X2 DITHER SAFELY
...
# NOTE: same as read2dfft_* but used np.fft.fft2 to accelerate
...
# NOTE: THIS IS THE ONLY FUNCTION MIGHT BE DIRECTLY USED IN APPLICATION
